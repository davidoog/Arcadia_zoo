window.addEventListener("load", function () {
    ...
    // Vérifie si le formulaire existe avant d'ajouter l'événement
    if (serviceForm) {
        ...
        // Si le formulaire n'existe pas dans le DOM, afficher un message dans la console
        console.error("Le formulaire 'manageServiceForm' n'existe pas dans le DOM.");
    }
});